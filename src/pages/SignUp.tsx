  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to Edu Scale. Redirecting to dashboard...",
      });
      navigate("/dashboard");
    } catch (error) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-subtle px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Start converting your grades today</p>
        </div>

        <div className="bg-card rounded-lg shadow-elegant border border-border p-8">
